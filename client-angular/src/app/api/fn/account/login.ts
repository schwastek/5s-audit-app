...
import { ApiLoginRequest } from '../../models/api-login-request';
...
export function login(http: HttpClient, rootUrl: string, params?: Login$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiUserDto>> {
